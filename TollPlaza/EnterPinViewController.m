...
- (IBAction)skipRegisterationClicked:(id)sender {
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Confirm" message:@"As You are skipping registration, please note that some of the features of app will not function." delegate:self cancelButtonTitle:@"Register" otherButtonTitles:@"Skip", nil];
    [alert show];
    //  [self gotoMainView];
}
