...
-(void)queryGooglePlacesForType: (NSString *)placeType
{
    ...
    NSString *url = [NSString stringWithFormat:@"https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=%@,%@&radius=5000&types=%@&key=AIzaSyCO4ggSITaVEVBpFF3frbkPeTHKsJ2vTXo", currentLatitude, currentLongitude, placeType];
    url = [url stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
